...
export function Sidebar({ onClose }: SidebarProps): JSX.Element {
  ...
  return (
    <aside className="h-full w-72 flex flex-col border-r border-gray-200 bg-gray-50 overflow-y-auto">
      {/* En-tête mobile avec bouton fermer */}
      <div className="flex items-center justify-between px-4 py-3 bg-[#1F3864] text-white md:hidden flex-shrink-0">
        <span className="text-sm font-bold uppercase tracking-widest">Paramètres</span>
        <button
          onClick={onClose}
          className="flex h-8 w-8 items-center justify-center rounded hover:bg-white/20 transition"
        >
      ...
      <div className="flex-1 p-4 overflow-y-auto">
        <h2 className="mb-4 text-xs font-bold uppercase tracking-widest text-[#1F3864] hidden md:block">
